...
const ListingRooms = ({ image, title, roomSize, price, amenities }) => {
    ...
    return (
        <div className="max-w-3/4 w-3/4 mx-auto font-poppins bg-white rounded-xl shadow-md overflow-hidden border mb-2">
            <div className="flex">
            ...
            <div className="px-4 py-3 bg-white flex justify-between items-center">
                ...
                <button
                    ...
                    className={`px-4 py-2 text-lg font-semibold rounded focus:outline-none ${isClicked
